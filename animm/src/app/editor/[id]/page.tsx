            ...
            {({ zoomIn, zoomOut, resetTransform, centerView, ...rest }) => (
              <>
                ...
                <TransformComponent wrapperClass="!w-full !h-full" >
                  <div id="MainCanvas" className="h-[1920px] w-[1080px] resizeItem flex rounded-lg border bg-white shadow-md shadow-slate-500/10">
        ...
        <div className="grid w-full gap-2.5">
          {templateData.text.map((text: any) => (
            <div className="grid w-full gap-1.5" key={text.v}>
              <label className="text-sm text-sidebar-foreground" htmlFor={text.v}>{text.name}</label>
              <Textarea
              id={text.v}
              ...
              <div className="grid gap-4">
                <div className="grid gap-2">
                  <div className="relative size-fit">
                    <Button className="text-xs p-3 h-8 rounded-lg absolute top-1/2 left-1/2 transition-opacity opacity-0 hover:opacity-100 z-50">Crop</Button>
                    <Image
                    width={300}
                    height={100}
                    alt=""
                ...
                <div className="grid gap-1.5">
                  ...
                  <Button className="text-xs p-3 h-8 rounded-lg">Remove Background</Button>
                  <Button className="text-xs p-3 h-8 rounded-lg">Expand Image</Button>
                </div>
              </div>
            </PopoverContent>
          </Popover>
